...
{
/// <summary>
/// Form that holds the Tranasaction cinforimatin dialog. 
/// </summary>
    public partial class RentalTransactionConfirmationDialog : Form
    {
        /// <summary>
        /// Dialog that presents the employee with a transaction confirmation
        /// </summary>
        ...
        private void CloseConfirmationPage_Click(object sender, System.EventArgs e) => this.Close();
